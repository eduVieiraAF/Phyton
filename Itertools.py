...
# the product of set X and set Y is the set that contains all ordered pairs ( x, y ) for which x belongs to X and y
# belongs to Y.
...
c = [1, 2, 3]
perm = permutations(c, 2)  # returns all possible orderings, length
print(list(perm))
