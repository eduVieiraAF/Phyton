...
#* The mathematical formula for Median is: Median = {(n + 1) / 2}th value, where n is the number of values in a set of data. In order to calculate the median, 
#* the data must first be sorted in ascending order. The median is the number in the middle.
