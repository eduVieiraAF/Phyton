...
print("Number of dimensions for array 'a' : {}".format(a.ndim))
print("Number of dimensions for array 'b' : {}".format(b.ndim))
print("Number of dimensions for array 'c' : {}".format(c.ndim))
print("Number of dimensions for array 'd' : {}".format(d.ndim))
